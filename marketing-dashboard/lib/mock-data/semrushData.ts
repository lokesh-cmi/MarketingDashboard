...
export const seoCheckerData = {
  ...
  totalPages: 40,
  categories: [
    { name: 'Strategy', count: 0, color: '#9333ea' },
    { name: 'Backlinks', count: 38, color: '#a855f7' },
    { name: 'User Experience', count: 41, color: '#c084fc' },
    { name: 'Technical SEO', count: 11, color: '#d8b4fe' },
    { name: 'SERP Features', count: 6, color: '#e9d5ff' },
    { name: 'Semantic', count: 33, color: '#7c3aed' },
    { name: 'Content', count: 133, color: '#8b5cf6' },
  ],
  topPages: [
